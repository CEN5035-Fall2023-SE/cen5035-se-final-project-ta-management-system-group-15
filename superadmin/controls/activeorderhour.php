...
if ($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET['id'])) {
    ...
    $query = "UPDATE orders_hourly SET status = 'Active' WHERE id = ?";
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            header("Location: ../ordershourly.php"); // Replace 'record_list.php' with the page where you list all records
            exit();
        } else {
