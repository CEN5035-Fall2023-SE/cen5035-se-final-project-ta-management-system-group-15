...
if ($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET['id'])) {
    ...
    $query = "DELETE FROM teacher_assistance_applications WHERE id = ?";
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            header("Location: applicants.php"); // Replace 'record_list.php' with the page where you list all records
            exit();
        } else {
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <form method="POST" action="">
                    ...
                    <a href="addcus" class="btn btn-secondary">Cancel</a>
                </form>
            </div>
        </div>
    </div>
